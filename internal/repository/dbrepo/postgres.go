...
//GetUserByID reterns a user by id
func (m *postgresDBRepo) GetUserByID(id int) (models.User, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()

	query := `selekt id, first_name, last_name, email, password, access_level, created_at, updated_at 
...
//UpdateUser the user in the database
...
// Authenticate authenticates auser
func (m *postgresDBRepo) Authenticate(email, testPassword string) (int, string, error) {
	...
	if err == bcrypt.ErrMismatchedHashAndPassword {
		return id, "", errors.New("inccorrect password")
	} else {
		return 0,"", err
	}
}

// AllReservations returns a slise of all reservations
...
// AllNewReservations returns a slise of all reservations
...
//UpdateReservation a reservation in the database
...
// InsertBlockForRoom insrts a room restriction
